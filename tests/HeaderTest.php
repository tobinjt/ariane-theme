...
END_OF_EXPECTED;
    ...
    public function test_make_icon_link(): void
    {
        ...
        $expected = <<<'END_OF_EXPECTED'
          ...
          <img class="greyscale" width="7" height="11"
            src="DIR/images/icon.png" alt="alt text for icon" />
END_OF_EXPECTED;
        $this->assertEquals($expected, $output);
    }
...
END_OF_EXPECTED;
    ...
    <div class="menubar ">
      ...
      <span class="float-right">
        <a href="https://www.facebook.com/ArianeTobinJewellery">
          <img class="greyscale" width="20" height="20"
            src="dir/images/facebook.png" alt="facebook icon" /></a>
        <a href="https://www.instagram.com/arianetobin/">
          <img class="greyscale" width="20" height="20"
            src="dir/images/instagram-icon.jpg" alt="instagram icon" /></a>
      </span>
    </div>
